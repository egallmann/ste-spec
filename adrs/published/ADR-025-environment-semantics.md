...
| Field | Value |
| --- | --- |
| **Canonical record** | Machine ADR **ADR-L-0025** — [`adrs/logical/ADR-L-0025-environment-semantics.yaml`](../logical/ADR-L-0025-environment-semantics.yaml) |
| **Human projection** | [`adrs/adr-projection/logical/ADR-L-0025-environment-semantics.md`](../adr-projection/logical/ADR-L-0025-environment-semantics.md) (generated; do not edit by hand) |
| **This file** | Legacy published markdown; **not canonical** |
| **Disposition** | Migrated one-to-one |

Authority: treat **ADR-L-0025** as the source of truth for decisions and invariants.
