...
| **ste-kernel** | `architecture-ir/` bundle (schema + YAML contract); `contracts/adapter-contracts.yaml`; kernel ADR corpus under `adrs/` | IR bundle: maintained; some indices generated |
