...
`contracts/`, `invariants/`, and canonical authored ADRs under `adrs/logical/`; it **indexes** the core boundary.
...
- Cross-component invariants: `invariants/STE-Cross-Component-Contract-Invariants.md`
  (INV-0001–INV-0009)
- Role split: [`ADR-L-0031`](../adrs/adr-projection/logical/ADR-L-0031-runtime-and-kernel-responsibility-boundary.md)
