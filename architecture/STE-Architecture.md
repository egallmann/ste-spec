...
- **Artifact classes:** STE classifies artifacts as Normative, Implementation,
  ...
  and [`ADR-L-0038`](../adrs/adr-projection/logical/ADR-L-0038-artifact-taxonomy-and-versioning-posture.md).
...
- **Architecture IR role:** Architecture IR is the canonical semantic model in
  ...
  and [`ADR-L-0035`](../adrs/adr-projection/logical/ADR-L-0035-architecture-ir-ontology-authority-in-ste-spec.md).
