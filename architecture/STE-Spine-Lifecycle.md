...
- `Publication` marks boundary material as available for integration input and
  downstream compilation.
- `Assessment (Reports)` includes report-like and review-like outputs already
  present in accepted doctrine.
- `Projection` is a representational posture generated from compiled, observed,
  or assessed material. It is not a state-bearing class.
